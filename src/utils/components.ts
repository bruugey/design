...
const titlecase = (component: Component) => {
  console.log({ component, lowered: toLower(component), start: startCase(component) })
  return startCase(toLower(component));
}

const generateComponentNavPath = (component: Component) => `/component/${component}/live-example`;
...
export const components: Array<{
  ...
  isPrivate?: boolean;
    ...
    { name: titlecase(Component.Button), navPath: generateComponentNavPath(Component.Button), group: Group.Notifications },
    {
    ...
    { name: titlecase(Component.Card), navPath: generateComponentNavPath(Component.Card), group: Group.Display },
    {
